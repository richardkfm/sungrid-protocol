...
`P0: Bootstrap`, `P1: Baseline Shell`, `P2: First Content Pass`, `P3: Grid Reserve MVP`, `P4: Playtest Hardening`, `P5: Faction Flavor`, `P6: World & UI Identity`, `P7: Sound & Music`, `P8: Diplomacy (conditional)`.
