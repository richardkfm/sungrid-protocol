...
| SGHAU | Hauler Drone | Both | inf | 500 | 22000 | Light | 100 | — | rcyd | Speed was unset (=1, effectively immobile) when first surveyed — see gap G1, since fixed. Later raised 72→100 (matched to HARV, then re-tuned — issue #86) since Light armor/22000 HP couldn't outrun what HARV's Heavy/60000 HP could |
